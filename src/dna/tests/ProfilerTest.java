...
public class ProfilerTest {
	...
	// if ((UndirectedEdge.class.isAssignableFrom(edgeType) &&
	// DirectedNode.class
	...
	// continue;
	//
	// EnumMap<ListType, Class<? extends IDataStructure>> listTypes = new
	// EnumMap<ListType, Class<? extends IDataStructure>>(
	// ListType.class);
