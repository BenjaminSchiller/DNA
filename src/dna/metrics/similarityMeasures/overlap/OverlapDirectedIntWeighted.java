 ...
 * </p>
 * 
 * @see OverlapDirectedIntWeightedR
 * @see OverlapDirectedIntWeightedU
 */
public abstract class OverlapDirectedIntWeighted extends
	...
	/**
	 * Initializes {@link OverlapDirectedIntWeighted}.
	 * 
	 * @param name
	 ...
	 */
	public OverlapDirectedIntWeighted(String name, Parameter directedDegreeType) {
