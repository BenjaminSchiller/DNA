 ...
 * @see DiceUndirected
 */
public class DiceUndirectedU extends DiceUndirected implements IBeforeUpdates, IAfterUpdates {

	/**
	 * Initializes {@link DiceUndirectedU}.
	 */
	public DiceUndirectedU() {
		super("DiceUndirectedU");
	}
	...
	protected void update(UndirectedNode node1, UndirectedNode node2) {
		...
		if (this.matching.get(node1, node2) == null
			...
			fraction = ((double) (2 * this.matching.get(node1, node2)))
					/ ((double) (this.amountOfNeighbors.get(node1) + this.amountOfNeighbors
							.get(node2)));
