...
public abstract class MeasuresDirectedIntWeighted extends Metric implements
		IMetric {
	...
	public MeasuresDirectedIntWeighted(String name) {
		this(name, new StringParameter("directedDegreeType", "out"));
	}
	 ...
	 */
	public MeasuresDirectedIntWeighted(String name, Parameter directedDegreeType) {
