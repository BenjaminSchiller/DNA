 ...
 */
public abstract class AssortativityH extends Metric implements IMetric {
	 ...
	 */
	public AssortativityH(String name) {
	 ...
	 */
	public AssortativityH(String name, DirectedDegreeType directedDegreeType,
			EdgeWeightType edgeWeightType) {
		super(name, IMetric.MetricType.heuristic, directedDegreeType
