...
<<<<<<< HEAD
	...
	private static final double[] Q95 = { 12.71, 4.303, 3.182, 2.776, 2.571,
			...
			2.064, 2.060, 2.056, 2.052, 2.048, 2.045, 2.042, 2.021, 2.009,
			2.000, 1.994, 1.990, 1.987, 1.984, 1.972, 1.968, 1.966, 1.965,
			1.960 };

	/**
	 * Returns the quantile of the Student's t-distribution wich a 0,95
	 * confidence niveau.
	 * 
	 * @param values
	...
	public static double getStudentT(double niveau, int degree) {
		// always returns quantiles for 0,95 confidence niveau. Others not
		// implented yet.
