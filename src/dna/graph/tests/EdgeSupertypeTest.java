...
public class EdgeSupertypeTest {
	...
	//
	// public EdgeSupertypeTest(Class<? extends Node> nodeType, Class<? extends
	// Edge> edgeType) {
	...
	// assumeTrue((DirectedNode.class.isAssignableFrom(nodeType) &&
	// DirectedEdge.class.isAssignableFrom(edgeType))
	// || (UndirectedNode.class.isAssignableFrom(nodeType) &&
	// UndirectedEdge.class.isAssignableFrom(edgeType)));
	//
