...
public class UndirectedIntArrayWeightedNode extends UndirectedNode implements
		IWeightedNode<int[]>, IIntArrayWeighted {

	private int[] weight;

	public UndirectedIntArrayWeightedNode(int index, int[] weight,
			GraphDataStructure gds) {
		super(index, gds);
		this.weight = weight;
	}

	public UndirectedIntArrayWeightedNode(String str, GraphDataStructure gds) {
	...
	public UndirectedIntArrayWeightedNode(int index, GraphDataStructure gds) {
		super(index, gds);
		this.weight = new int[0];
	}
