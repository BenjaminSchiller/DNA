...
public class DirectedDoubleArrayWeightedNode extends DirectedNode implements
		IWeightedNode<double[]>, IDoubleArrayWeighted {

	private double[] weight;

	public DirectedDoubleArrayWeightedNode(int index, double[] weight,
			GraphDataStructure gds) {
		super(index, gds);
		this.setWeight(weight);
	}

	public DirectedDoubleArrayWeightedNode(String str, GraphDataStructure gds) {
	...
	public DirectedDoubleArrayWeightedNode(int index, GraphDataStructure gds) {
		super(index, gds);
