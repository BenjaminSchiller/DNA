...
import dna.depr.metrics.similarityMeasures.MeasuresUndirectedIntWeighted;
 ...
 */
public abstract class OverlapUndirectedIntWeighted extends
	 ...
	 */
	private double getMin(HashMap<UndirectedNode, Integer> neighbors1,
	...
	public boolean isComparableTo(Metric m) {
		return m != null && m instanceof OverlapUndirectedIntWeighted;
	}
