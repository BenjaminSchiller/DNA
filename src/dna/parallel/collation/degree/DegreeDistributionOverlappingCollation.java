...
public class DegreeDistributionOverlappingCollation extends
		Collation<DegreeDistribution, OverlappingPartition> {

	public DegreeDistributionOverlappingCollation(String auxDir,
			String inputDir, int partitionCount, int run, Sleeper sleeper) {
		super("DegreeDistributionOverlappingCollation", MetricType.exact,
				PartitionType.Overlapping, new DegreeDistributionR(), auxDir,
