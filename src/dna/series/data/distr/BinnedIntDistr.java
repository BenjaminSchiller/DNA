...
public class BinnedIntDistr extends BinnedDistr<Integer> {
	...
	public BinnedIntDistr(String name, Integer binSize, long denominator,
			long[] values) {
		super(name, binSize, denominator, values);
	}

	public BinnedIntDistr(String name, String binSize, long denominator,
			long[] values) {
		super(name, Integer.parseInt(binSize), denominator, values);
	}
